...
id: llm-service
title: LLM Service
description: "Language model service providing academic writing and paper development capabilities"
tags: [Production]
connections: []
metadata:
  serviceType: llm
...
Provides access to a large language model for academic writing and paper development. Used by all skills in this skrpt.
